...
const ShipmentStats = () => {
  ...
  const CustomSelect = styled(Select)(({ theme }) => ({
    ...
    "& .MuiSvgIcon-root": {
      color: theme.palette.warning.main, // Dropdown arrow color
    },
  }));
  ...
  const StyledMenuItem = styled(MenuItem)(({ theme }) => ({
    ...
    // fontWeight: "bold",
    "&.Mui-selected": {
      backgroundColor: "rgba(252, 118, 3,0.2)", // Selected item color
      color: theme.palette.warning.dark,
    },
    "&:hover": {
      backgroundColor: "rgba(252, 118, 3,0.09)", // Hover color
    },
  }));
