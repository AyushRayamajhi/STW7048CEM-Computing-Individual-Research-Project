...
const MATCH_DAYS = Array.from({ length: 35 }, (_, i) => i + 1);

// 🔴 Only two options now: Goals (radar) + Efficiency (bars)
const GRAPH_OPTIONS = [
  { id: "goals", label: "Goals" }, // uses RadarTeamChart
  { id: "efficiency", label: "Efficiency" }, // uses MatchEfficiencyChart
  { id: "luckskill", label: "Luck Skill" }, // uses MatchEfficiencyChart
];
